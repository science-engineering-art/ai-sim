...
class control:
    ...
    def __init__(self):
        ...
        self.basic_vehicles = [
            Vehicle(x=0, length=3, width=1, color=(
                30, 255, 255), v_max=80, a_max=1.9, b_max=3.5),
            Vehicle(x=0, length=3, width=1.5, color=(
                255, 30, 255), v_max=30, a_max=2.9, b_max=3),
            Vehicle(x=0, length=2, width=0.85, color=(
                255, 255, 30), v_max=40, a_max=2.2, b_max=4),
            Vehicle(x=0, length=2.5, width=1.2, color=(
                118, 181, 197), v_max=65, a_max=4.9, b_max=1.5),
            ...
            for road_id in range(len(self.roads)):  # for each road....
                ...
                if type(road.end_conn) == corner and not road.end_conn.CanIPass(road_id):
                    ...
                    road.vehicles.appendleft(
                        Vehicle(road.length, 3, 1, color=RED))
